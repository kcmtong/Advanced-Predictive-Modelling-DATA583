...
#### Purpose 
Do some visualisation to explore and identify the general data pattern, trends and clusters, etc
...
- The general life expectancy has been steadily increasing along with the years, from about 67 to the new height of 71.5 in 15 years.
...
- The mortality rate of the adult group, however, have fluctuation within the period, compared with the other two groups which show steady decline over the period.
...
df_ns = subset(le_dropped, select =-c(Country,GDP,Population) )
head(df)
```
...
df2 = subset(le_dropped, select = -c(Country,GDP,Population) )
head(df2)
